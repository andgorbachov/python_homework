...
--
-- Name: result_table; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.result_table (
    id_film character varying(100),
    id_director character varying(100),
    id_actor character varying(100)
);


ALTER TABLE public.result_table OWNER TO postgres;
...
3	The Queens Gambit	Scott Frank 
1	Heat	Michael Mann
...
--
-- Data for Name: result_table; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.result_table (id_film, id_director, id_actor) FROM stdin;
1	2	4
1	2	5
1	2	6
2	3	7
